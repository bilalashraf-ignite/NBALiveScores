...
- [x] **STAT-03**: User can view individual player statistics during live games
- [x] **STAT-04**: User can see player points, rebounds, and assists
...
- [x] **PERF-01**: User experiences sub-1-second initial page load on desktop
